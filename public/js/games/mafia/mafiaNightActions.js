/**
 * Mafia Night Actions UI Controller (Murderers, Doctor, Detective, Sleeping Town, Spectators)
 */
...
const MafiaNightActions = {
  render(state) {
    ...
    const isNightPhase = state.phase && state.phase.startsWith('night_') && !state.winner;
